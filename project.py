...
def plt_ant_feat(z, x=None, y=None, fig=None, ax=None, cmap='jet', vmin=20, vmax=135, hide_water=True, label='', title='', kwargs_mesh={'shading':'gouraud', 'aa':True}, kwargs_cbar={}):
